...
@TableName("vehicle_data_before")
public class VehicleDataBefore extends VehicleData{
    ...
    public VehicleDataBefore() {
    }

    public VehicleDataBefore(int speedLimit, int sceneLimit, int randSeed, int simulationTime, int vehicleNumber,
    ...
    public VehicleDataBefore(int densityBefore, int densityAfter, int speedLimit, int sceneLimit, int randSeed,
