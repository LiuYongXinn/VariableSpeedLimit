...
%%
function ReinforceLearningForLaneCloseByDensity_2248(vissimFileName,vissimPathName,vissimUnifiedName,...
...
discountFactor = 0.8;
%动作集
[limitSet,motionSet] = AgentActionDefine("construction");
...
for tti = 1 : trainingNum
    ...
    while step <= evaluationTime
        ...
        if(step == 600)
            ...
            [speedLimit1, speedLimit2] = AgentActionChooseForTwoSpeed(action, limitSet, motionSet);
