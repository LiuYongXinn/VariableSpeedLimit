...
%%
function ReinforceLearningForLaneCloseByPET_2248(vissimFileName,vissimPathName,vissimUnifiedName,...
 ...
 %% 车流量设置和减速区域设置
    ...
    while step <= evaluationTime
        ...
        if(step >= 300 && step < 600 && mod(step,60) == 0)
            ...
            PETTimes = PETTimesCalculate_All(step, vehicleDataLane1, vehicleDataLane2);
            PETTimesSum1 = PETTimesSum1 + PETTimes;
            ConvertInvadeTimeForSceneAndUpstream_All(2,invadeLineSet);
