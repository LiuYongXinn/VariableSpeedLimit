...
% 
function ReinforceLearningForOneSpeedByDensity(vissimFileName,vissimPathName,vissimUnifiedName,...
...
discountFactor = 0.8;
%动作集
[limitSet,~] = AgentActionDefine("turning");
% 根据不同的天气选择不同的Q表
...
for tti = 1 : trainingNum
    ...
    while step <= evaluationTime
        ...
        if(step == 600)
            ...
            speedLimit = AgentActionChooseForOneSpeed(action, limitSet);
